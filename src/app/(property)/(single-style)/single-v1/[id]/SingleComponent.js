          ...
          <div className="row wrap">
            <div className="col-lg-8">
              ...
              <div className="ps-widget bgc-white bdrs12 default-box-shadow2 p30 mb30 overflow-hidden position-relative">
                ...
                <ProperytyDescriptions id={params.id} listings={listings}/>
                ...
                <div className="row">
                  <PropertyDetails id={params.id} listings={listings}/>
                </div>
              </div>
              {/* End .ps-widget */}
              ...
              <div className="ps-widget bgc-white bdrs12 default-box-shadow2 p30 mb30 ">
                ...
                <div className="row">
                  <PropertyVideo id={params.id} listings={listings}/>
                </div>
              </div>
              {/* End .ps-widget */}
              ...
              {/* <div className="ps-widget bgc-white bdrs12 default-box-shadow2 p30 mb30 overflow-hidden position-relative">
                <h4 className="title fz17 mb30">Que hay cerca?</h4>
                <div className="row">
                  <PropertyNearby />
                </div>
              </div> */}
          ...
          <div className="row mt30 align-items-center justify-content-between">
            <div className="col-auto">
              <div className="main-title">
                <h2 className="title">Descubre mas propiedades</h2>
                <p className="paragraph">
                  Has tus sueños realidad con nosotros
                </p>
              </div>
            </div>
            {/* End header */}
          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="property-city-slider">
                <NearbySimilarProperty listings={listings} />
              </div>
            </div>
          </div>
          {/* End .row */}
